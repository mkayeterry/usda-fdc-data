...
processed_branded_food = process_branded_food(Config.BF_BRANDED_FOOD, Config.BF_FOOD_NUTRIENT, Config.BF_FOOD, Config.BF_NUTRIENT, Config.BF_CATEGORY, Config.BF_PORTION, Config.BF_MEASURE_UNIT)
