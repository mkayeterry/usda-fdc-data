...
def process_foundation_and_sr_legacy(
    ...
    categories['category'] = categories['category'].fillna('no_value').astype(str)
    ...
    portions['portion_modifier'] = portions['portion_modifier'].fillna('no_value').astype(str)
    ...
    full_foods_pivot['brand_owner'] = 'no_value'
    full_foods_pivot['brand_name'] = 'no_value'
    full_foods_pivot['ingredients'] = 'no_value'
